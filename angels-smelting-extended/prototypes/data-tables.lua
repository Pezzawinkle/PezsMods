...
a_inters={
  ...
  ["cable-shielding-1"]={metal="copper",icon="cable-shield-1",tech="angels-components-cabling-2",cost=1,amount=2},
  ["cable-shielding-2"]={metal="tin",icon="cable-shield-2",tech="angels-components-cabling-2",cost=1,amount=2},
  ["cable-shielding-3"]={metal="silver",icon="cable-shield-3",tech="angels-components-cabling-3",cost=1,amount=2},
  ["cable-shielding-4"]={metal="gold",icon="cable-shield-4",tech="angels-components-cabling-4",cost=1,amount=2},
  ["cable-shielding-5"]={metal="platinum",icon="cable-shield-5",tech="angels-components-cabling-5",cost=1,amount=2},
}
