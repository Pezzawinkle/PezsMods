...
data:extend({
  {
    ...
    icons =generate_fluid_recipe_icons("butadiene","cht","gas"), -- no - marks in name, second part is a 3 letter code, thrid part is gas/liquid or blank
  ...
  },
  {
    ...
    icons =generate_fluid_recipe_icons("dichlorobutene","clh","liq"),
  ...
  },
  {
    ...
    icons =generate_fluid_recipe_icons("chlorobutadiene","clh","liq"),
...
data:extend({
  {
    ...
    icons =generate_fluid_recipe_icons("acetylene","cht","gas"),
  ...
  },
  {
    ...
    icons =generate_fluid_recipe_icons("vinyl_acetylene","cch","gas"),
